...
class SciRepEvalRelishReranking(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="SciRepEvalRelishReranking",
        description="Reranking task based on the RELISH dataset to identify relevant biomedical papers for a given query paper, from the SciRepEval benchmark.",
