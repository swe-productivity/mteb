...
class SciRepEvalSameAuthorReranking(AbsTaskRetrieval):
    metadata = TaskMetadata(
        name="SciRepEvalSameAuthorReranking",
        description="Reranking task to identify papers by the same author as a given query paper, from the SciRepEval benchmark.",
